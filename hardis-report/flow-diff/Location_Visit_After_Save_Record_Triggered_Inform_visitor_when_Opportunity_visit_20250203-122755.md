<span style="background-color: #a6e22e; color: black;"><b>🟩# [Location Visit][After-Save][Record-Triggered] Inform visitor when Opportunity visit</b></span>
...
click START "#general-information" "928323634"

Get_Notification[("<b>🔍 <em></em><br/>Get Notification</b>")]:::recordLookupsAdded
click Get_Notification "#get_notification" "1460495695"

Get_Notification ==> END_Get_Notification
START ==>  Get_Notification
END_Get_Notification(( END )):::endClassAdded
...
|:---|:---|
|🟩<span style="background-color: #a6e22e; color: black;"><b>Object</b></span>|<span style="background-color: #a6e22e; color: black;"><b>Location_Visit__c</b></span>|
...
|🟩<span style="background-color: #a6e22e; color: black;"><b>Label</b></span>|<span style="background-color: #a6e22e; color: black;"><b>[Location Visit][After-Save][Record-Triggered] Inform visitor when Opportunity visit</b></span>|
...
|🟩<span style="background-color: #a6e22e; color: black;"><b>Filter Formula</b></span>|<span style="background-color: #a6e22e; color: black;"><b>(ISNEW() && NOT(ISNULL( {!$Record.Visitor_Internal__c})))<br/></b></span>|<span style="background-color: #a6e22e; color: black;"><b><br/>(ISCHANGED({!$Record.Visitor_Internal__c})&&NOT(ISNULL( {!$Record.Visitor_Internal__c})))</b></span>|
|🟩<span style="background-color: #a6e22e; color: black;"><b>Description</b></span>|<span style="background-color: #a6e22e; color: black;"><b>Send a notification to the expected visitor that they are expected to do a visit</b></span>|
...
|🟩<span style="background-color: #a6e22e; color: black;"><b>Interview Label</b></span>|<span style="background-color: #a6e22e; color: black;"><b>[Location Visit][After-Save][Record-Triggered] Inform visitor when Opportunity visit {!$Flow.CurrentDateTime}</b></span>|
...
|🟩<span style="background-color: #a6e22e; color: black;"><b>Next Node</b></span>|<span style="background-color: #a6e22e; color: black;"><b>[Get_Notification](#get_notification)</b></span>|
...
|🟩<span style="background-color: #a6e22e; color: black;"><b>Label</b></span>|<span style="background-color: #a6e22e; color: black;"><b>Get Notification</b></span>|
