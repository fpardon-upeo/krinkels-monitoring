<span style="background-color: #a6e22e; color: black;"><b>🟩# [Service Appointment][After-Save][Record-Triggered] Update Related WO Status</b></span>
...
click START "#general-information" "1948916251"

Update_Related_Work_Order_Status[("<b>🛠️ <em></em><br/>Update Related Work Order Status</b>")]:::recordUpdatesAdded
click Update_Related_Work_Order_Status "#update_related_work_order_status" "3526102979"

Update_Related_Work_Order_Status ==> END_Update_Related_Work_Order_Status
START ==>  Update_Related_Work_Order_Status
END_Update_Related_Work_Order_Status(( END )):::endClassAdded
...
|🟩<span style="background-color: #a6e22e; color: black;"><b>Label</b></span>|<span style="background-color: #a6e22e; color: black;"><b>[Service Appointment][After-Save][Record-Triggered] Update Related WO Status</b></span>|
...
|🟩<span style="background-color: #a6e22e; color: black;"><b>Description</b></span>|<span style="background-color: #a6e22e; color: black;"><b>This flow updates the status of the related work order so that it is aligned and has the same status.</b></span>|
...
|🟩<span style="background-color: #a6e22e; color: black;"><b>Interview Label</b></span>|<span style="background-color: #a6e22e; color: black;"><b>[Service Appointment][After-Save][Record-Triggered] Update Related WO Status {!$Flow.CurrentDateTime}</b></span>|
...
|🟩<span style="background-color: #a6e22e; color: black;"><b>Connector</b></span>|<span style="background-color: #a6e22e; color: black;"><b>[Update_Related_Work_Order_Status](#update_related_work_order_status)</b></span>|
|🟩<span style="background-color: #a6e22e; color: black;"><b>Next Node</b></span>|<span style="background-color: #a6e22e; color: black;"><b>[Update_Related_Work_Order_Status](#update_related_work_order_status)</b></span>|
...
|🟩<span style="background-color: #a6e22e; color: black;"><b>Label</b></span>|<span style="background-color: #a6e22e; color: black;"><b>Update Related Work Order Status</b></span>|
...
|:-- |:--: |
|🟩<span style="background-color: #a6e22e; color: black;"><b>Status</b></span>|<span style="background-color: #a6e22e; color: black;"><b>$Record.Status</b></span>|
