<span style="background-color: #a6e22e; color: black;"><b>🟩# [Service Appointment][After-Save][Record-Triggered] Add Start Date and Retrigger Notification Send</b></span>
...
Retrigger_notification{"<b>🔀 <em></em><br/>Retrigger notification</b>"}:::decisionsAdded
click Retrigger_notification "#retrigger_notification" "1832325384"

Get_Work_Order[("<b>🔍 <em></em><br/>Get Work Order</b>")]:::recordLookupsAdded
click Get_Work_Order "#get_work_order" "2302282943"

Retrigger_Notification_Send[("<b>🛠️ <em></em><br/>Retrigger Notification Send</b>")]:::recordUpdatesAdded
click Retrigger_Notification_Send "#retrigger_notification_send" "1470581268"

Update_Start_Date_Work_Order[("<b>🛠️ <em></em><br/>Update Start Date Work Order</b>")]:::recordUpdatesAdded
click Update_Start_Date_Work_Order "#update_start_date_work_order" "3788572289"

Retrigger_notification ==> |"🟩<b>Yes</b>"| Retrigger_Notification_Send
Retrigger_notification ==> |"🟩<b>No</b>"| Update_Start_Date_Work_Order
...
|🟩<span style="background-color: #a6e22e; color: black;"><b>Label</b></span>|<span style="background-color: #a6e22e; color: black;"><b>[Service Appointment][After-Save][Record-Triggered] Add Start Date and Retrigger Notification Send</b></span>|
...
|🟩<span style="background-color: #a6e22e; color: black;"><b>Filter Formula</b></span>|<span style="background-color: #a6e22e; color: black;"><b>(TEXT({!$Record.Status} )= "Scheduled"<br/>&&<br/>ISCHANGED({!$Record.SchedStartTime}))</b></span>|
|🟩<span style="background-color: #a6e22e; color: black;"><b>Description</b></span>|<span style="background-color: #a6e22e; color: black;"><b>Flow that sents field to retrigger the notification to the customer if a SA is rescheduled</b></span>|
...
|🟩<span style="background-color: #a6e22e; color: black;"><b>Interview Label</b></span>|<span style="background-color: #a6e22e; color: black;"><b>[Service Appointment][After-Save][Record-Triggered] Add Start Date and Retrigger Notification Send {!$Flow.CurrentDateTime}</b></span>|
...
|🟩<span style="background-color: #a6e22e; color: black;"><b>Connector</b></span>|<span style="background-color: #a6e22e; color: black;"><b>[Get_Work_Order](#get_work_order)</b></span>|
|🟩<span style="background-color: #a6e22e; color: black;"><b>Next Node</b></span>|<span style="background-color: #a6e22e; color: black;"><b>[Get_Work_Order](#get_work_order)</b></span>|
...
|:-- |:--:|:-- |:--  |
|🟩<span style="background-color: #a6e22e; color: black;"><b>ScheduledDate</b></span>|<span style="background-color: #a6e22e; color: black;"><b>Date</b></span>|<span style="background-color: #a6e22e; color: black;"><b>DATEVALUE({!$Record.SchedStartTime})</b></span>|<span style="background-color: #a6e22e; color: black;"><b><!-- --></b></span>|
...
|🟩<span style="background-color: #a6e22e; color: black;"><b>Label</b></span>|<span style="background-color: #a6e22e; color: black;"><b>Retrigger notification</b></span>|
|🟩<span style="background-color: #a6e22e; color: black;"><b>Default Connector</b></span>|<span style="background-color: #a6e22e; color: black;"><b>[Update_Start_Date_Work_Order](#update_start_date_work_order)</b></span>|
...
|🟩<span style="background-color: #a6e22e; color: black;"><b><!-- --></b></span>|<span style="background-color: #a6e22e; color: black;"><b><!-- --></b></span>|
|:---|:---|
|🟩<span style="background-color: #a6e22e; color: black;"><b>Connector</b></span>|<span style="background-color: #a6e22e; color: black;"><b>[Retrigger_Notification_Send](#retrigger_notification_send)</b></span>|
...
|:-- |:-- |:--:|:--: |
|🟩<span style="background-color: #a6e22e; color: black;"><b>1</b></span>|<span style="background-color: #a6e22e; color: black;"><b>$Record.Scheduling_Notification_Send__c</b></span>|<span style="background-color: #a6e22e; color: black;"><b> Equal To</b></span>|<span style="background-color: #a6e22e; color: black;"><b>Send</b></span>|
...
|🟩<span style="background-color: #a6e22e; color: black;"><b>Label</b></span>|<span style="background-color: #a6e22e; color: black;"><b>Get Work Order</b></span>|
...
|🟩<span style="background-color: #a6e22e; color: black;"><b>Connector</b></span>|<span style="background-color: #a6e22e; color: black;"><b>[Retrigger_notification](#retrigger_notification)</b></span>|
...
|🟩<span style="background-color: #a6e22e; color: black;"><b>Label</b></span>|<span style="background-color: #a6e22e; color: black;"><b>Retrigger Notification Send</b></span>|
...
|🟩<span style="background-color: #a6e22e; color: black;"><b>Connector</b></span>|<span style="background-color: #a6e22e; color: black;"><b>[Update_Start_Date_Work_Order](#update_start_date_work_order)</b></span>|
...
|:-- |:--: |
|🟩<span style="background-color: #a6e22e; color: black;"><b>Scheduling_Notification_Send__c</b></span>|<span style="background-color: #a6e22e; color: black;"><b>Resend Needed</b></span>|
...
|🟩<span style="background-color: #a6e22e; color: black;"><b>Type</b></span>|<span style="background-color: #a6e22e; color: black;"><b>Record Update</b></span>|
|🟩<span style="background-color: #a6e22e; color: black;"><b>Object</b></span>|<span style="background-color: #a6e22e; color: black;"><b>WorkOrder</b></span>|
|🟩<span style="background-color: #a6e22e; color: black;"><b>Label</b></span>|<span style="background-color: #a6e22e; color: black;"><b>Update Start Date Work Order</b></span>|
...
|🟩<span style="background-color: #a6e22e; color: black;"><b>Field</b></span>|<span style="background-color: #a6e22e; color: black;"><b>Value</b></span>|
|:-- |:--: |
|🟩<span style="background-color: #a6e22e; color: black;"><b>Scheduled_Date__c</b></span>|<span style="background-color: #a6e22e; color: black;"><b>ScheduledDate</b></span>|
