...
Get_LMRA[("🔍 <em></em><br/>Get LMRA")]:::recordLookups
...
|Label|[Work Step][After-Save][Record-Triggered] Relink Photo to LMRA record|
|Status|Active|
|Environments|Default|
|Interview Label|[Work Step][After-Save][Record-Triggered] Relink Photo to LMRA record {!$Flow.CurrentDateTime}|
...
|:-- |:--:|:-- |:--  |
|TitleFormat|String|"LMRA - " + {!Loop_Through_Content_Document.Title} +"_"+TEXT({!FileCounter})|<!-- -->|
...
|RelinkRecord.LinkedEntityId| Assign|Get_LMRA.Id|
...
|Filter Id|Field|Operator|Value|
|:-- |:-- |:--:|:--: |
|1|Work_Order__c| Equal To|$Record.WorkOrderId|
