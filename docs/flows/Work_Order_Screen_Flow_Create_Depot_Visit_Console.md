# [Work Order][Screen-Flow] Create Depot Visit Console
...
click START "#general-information" "3758662960"
...
|:---|:---|
|Process Type| Flow|
|Label|[Work Order][Screen-Flow] Create Depot Visit Console|
|Status|⚠️ Draft|
|Environments|Default|
|Interview Label|[Work Order][Screen-Flow] Create Depot Visit Console {!$Flow.CurrentDateTime}|
