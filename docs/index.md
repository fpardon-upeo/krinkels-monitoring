...
| :----------- | :---------- |
| [package-all-org-items.xml](package-all-org-items.xml.md) (11863) | Contains the entire list of metadatas that are present in the monitored orgs (not all of them are in the git backup) |
