...
### `testSetReadyForValidation_Success()`

`ISTEST`

#### Signature
```apex
private static void testSetReadyForValidation_Success()
```
...
### `testSetReadyForValidation_InvalidProjectCode()`

`ISTEST`

#### Signature
```apex
private static void testSetReadyForValidation_InvalidProjectCode()
```
...
### `testGetATAKProjectsForNotification()`

`ISTEST`

#### Signature
```apex
private static void testGetATAKProjectsForNotification()
```
...
#### Signature
```apex
private static void testGetATAKProjects()
```
