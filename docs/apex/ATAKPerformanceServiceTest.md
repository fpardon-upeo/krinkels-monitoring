# ATAKPerformanceServiceTest Class
 ...
 */
    ...
    static void testFirstAndLastTravelFiltering() {
        ...
        System.debug(wrapper.data.size());
    ...
    static void testMaterialConsumption() {
        ...
        for(ATAKPerformanceWrapper.Data data : wrapper.data) {
            if(data.performance_resource_type == 'E') {
                foundMaterial = true;
                System.assertEquals('1.00000', data.quantity, 'Material quantity should match');
...
#### Signature
```apex
private static void testWorkLogService()
```
...
### `testFirstAndLastTravelFiltering()`
...
#### Signature
```apex
private static void testFirstAndLastTravelFiltering()
```
...
### `testFirstAndLastTravelFilteringIndoor()`
...
#### Signature
```apex
private static void testFirstAndLastTravelFilteringIndoor()
```
...
### `testScenario1_DepotFramingWithMileage()`
...
#### Signature
```apex
private static void testScenario1_DepotFramingWithMileage()
```
...
### `testScenario3_MultipleDepotVisits()`
...
#### Signature
```apex
private static void testScenario3_MultipleDepotVisits()
```
...
### `testScenario2_AllProductionWithMileage()`
...
#### Signature
```apex
private static void testScenario2_AllProductionWithMileage()
```
...
#### Signature
```apex
private static void testScenario1_DepotFraming()
```
...
### `testScenario2_AllProductionWork()`
...
#### Signature
```apex
private static void testScenario2_AllProductionWork()
```
...
#### Signature
```apex
private static void testWinterServiceAllowance()
```
...
### `testScenario4_MixedDayWithDepot()`
...
#### Signature
```apex
private static void testScenario4_MixedDayWithDepot()
```
...
#### Signature
```apex
private static void testMileageEntries()
```
...
#### Signature
```apex
private static void testMaterialConsumption()
```
