...
### `getServiceResources(territoryId)`
...
### `createAssignedResource(serviceResourceId, serviceAppointmentId, startDate)`
...
### `calculateDistance(firstLatitude, firstLongitude, secondLatitude, secondLongitude)`
...
| Name | Type | Description |
|------|------|-------------|
| firstLatitude | Decimal |  |
| firstLongitude | Decimal |  |
| secondLatitude | Decimal |  |
| secondLongitude | Decimal |  |
...
### `getScheduledAppointments(resourceId, startDate)`
