...
import timeSheetHeader_HoursText from "@salesforce/label/c.timeSheetHeader_HoursText";
import TimeSheet_LoggedText from "@salesforce/label/c.TimeSheet_LoggedText";
import TimeSheet_ExpectedText from "@salesforce/label/c.TimeSheet_ExpectedText";
import TimeSheet_MissingText from "@salesforce/label/c.TimeSheet_MissingText";
import TimeSheet_KmLoggedText from "@salesforce/label/c.TimeSheet_KmLoggedText";
import TimeSheet_TravelTimeText from "@salesforce/label/c.TimeSheet_TravelTimeText";
import TimeSheet_BreakTimeText from "@salesforce/label/c.TimeSheet_BreakTimeText";
...
export default class TimeSheetHeader extends LightningElement {
  ...
  labels = {
    ...
    timeSheetHeader_HoursText,
    TimeSheet_LoggedText,
    TimeSheet_ExpectedText,
    TimeSheet_MissingText,
    TimeSheet_KmLoggedText,
    TimeSheet_TravelTimeText,
    TimeSheet_BreakTimeText
  };
  ...
  timeSheetQueryResult({ error, data }) {
    if (data) {
      ...
      if (data.uiapi.query.TimeSheet.edges.length === 0) {
        ...
        this.workingTime =
          data.uiapi.query.TimeSheet.edges[0].node.Total_Normal_Hours__c.value;
        this.totalHoursLogged =
          data.uiapi.query.TimeSheet.edges[0].node.Total_Hours__c.value;
        this.travelTime =
          data.uiapi.query.TimeSheet.edges[0].node.Total_Travel_Time__c.value;
        this.totalDistance =
          data.uiapi.query.TimeSheet.edges[0].node.Total_KM__c.value;
