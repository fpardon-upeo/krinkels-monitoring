...
export default class CreateInternalWorkOrder extends LightningElement {
  ...
  async handleSave() {
    try {
      ...
      const serviceAppointment = await this.createServiceAppointment(workOrder.id);
  ...
  async createWorkOrder() {
    ...
    return await createRecord({ apiName: 'WorkOrder', fields: workOrderFields });
  }
  ...
  async createServiceAppointment(workOrderId) {
    ...
    return await createRecord({ apiName: 'ServiceAppointment', fields: serviceAppointmentFields });
  }
  ...
  async createAssignedResource(serviceAppointmentId) {
    ...
    return await createRecord({ apiName: 'AssignedResource', fields: assignedResourceFields });
  }
